const user = {
  name: "Max",
  surname: "Abulkhanov",
  userPhoto: "DSC07531.JPG",
  qrQode: "qr-code.svg",
  dreams: [
    { src: "my images for IT.jpg", alt: "I want to be a programer that is very good at his job" },
    { src: "Kayak sprint.jpg", alt: "I want to be an Athlete" },
    { src: "Explorer.jpg", alt: "I want to explore nature" },
  ],
};
